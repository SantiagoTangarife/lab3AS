...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CALENDARIO_LIST actions', async () => {
    ...
    it('dispatches FETCH_CALENDARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CALENDARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CALENDARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CALENDARIO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CALENDARIO actions', async () => {
      const expectedActions = [
        {
