...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './decano.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DECANO_LIST actions', async () => {
    ...
    it('dispatches FETCH_DECANO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DECANO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DECANO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DECANO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DECANO actions', async () => {
      const expectedActions = [
        {
