...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VICEDECANO_LIST actions', async () => {
    ...
    it('dispatches FETCH_VICEDECANO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_VICEDECANO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_VICEDECANO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_VICEDECANO actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_VICEDECANO actions', async () => {
      const expectedActions = [
        {
