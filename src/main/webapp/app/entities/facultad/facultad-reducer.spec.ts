...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './facultad.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FACULTAD_LIST actions', async () => {
    ...
    it('dispatches FETCH_FACULTAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_FACULTAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_FACULTAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_FACULTAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_FACULTAD actions', async () => {
      const expectedActions = [
        {
